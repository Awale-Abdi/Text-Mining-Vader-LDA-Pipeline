...
The dataset was sourced from Kaggle and includes over **1 million tweets** collected across three different time periods during the pandemic. These files were used for all cleaning, preprocessing, and modeling tasks and to simulate a real-world data workflow AWS S3 was utilized for storage. Link can be found below.
