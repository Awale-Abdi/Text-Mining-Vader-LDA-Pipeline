This folder only contains a link to the main deliverables for the **COVID-19 Twitter NLP Project**, to simulate a real-world data workflow by utilizing AWS S3 for storage:
